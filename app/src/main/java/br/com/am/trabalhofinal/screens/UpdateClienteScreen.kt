...
fun UpdateClienteScreen(
    ...
    if(flag == 0){
        cpf = Transition.cliente!!.cpf
        nome = Transition.cliente!!.nome
        telefone = Transition.cliente!!.telefone
        endereco = Transition.cliente!!.endereco
        flag = 1
    }
        ...
        Column(
            ...
            Column(
                ...
                Button(onClick = {
                    ...
                    dao.atualizarCliente(Cliente(cpf, nome, telefone, endereco))
